...
export default function CartPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 pb-20">
        ...
        <div className="flex flex-col items-center justify-center h-96 px-4">
          ...
          <p className="text-gray-600 text-center mb-6">Add some delicious items to get started</p>
          <button
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      {showMobilePopup && <MobileNumberPopup onSubmit={handleMobileSubmit} onClose={() => setShowMobilePopup(false)} />}
    </div>
  )
}